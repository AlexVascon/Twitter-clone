...
function StartSignupStep(props) {
  ...
  return (
    ...
    <TwitterIcon className='twitter-logo' color='primary'/>
      ...
      <TextField className='input-email' id="standard-basic" label="Email address" variant="standard" value={email} onChange={handleEmailChange}/>
...
export default StartSignupStep;
